...
public class NewUserDao {
  ...
  private static final String NEW_USER_STMT = "INSERT INTO " +
      "Users (email, password, first_name, last_name, gender, hometown, date_of_birth) VALUES (?, ?, ?, ?, ?, ?, ?)";

  public boolean create(String email, String password, String first_name, 
    String last_name, String gender, String hometown, Date dob) {
